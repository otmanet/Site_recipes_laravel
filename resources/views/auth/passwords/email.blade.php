            ...
            <div style="width: 600px;">
                <div class="card" style="height: 250px">
                    <div class=" card-header">
                        <p style="font-size: 25px;color: #14bf96 ;float: right;">{{ __('إعادة تعيين كلمة المرور') }}
                        </p>
                    </div>
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <form method="POST" action="{{ route('password.email') }}">
                            ...
                            <div class="form-group row">
                                <label for="email" class="col-md-4 col-form-label text-md-right">
                                    <p style="font-size: 25px;color:#14bf96">{{ __('عنوان بريد الكتروني') }}</p>
                                </label>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    <button type="submit" class="otm-login-btn" style="width: 350px">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                                    ...
                                    style="border-radius: 1.5rem;width: 350px;height: 40px;font-size: 25px">
                                @error('email')
                                <span class="invalid-feedback" role="alert" style="font-size: 25px;text-align: right">
                                    <strong>{{ $message }}</strong>
                                </span>
                                @enderror
                            </div>
